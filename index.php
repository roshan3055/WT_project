					...
					<section id="footer">
						<div class="inner">
							...
							<ul class="contact">
								...
								<li class="icon solid fa-phone">+91 8496 045 045</li>
								<li class="icon solid fa-envelope"><a href="#">SRSProject@gmail.com</a></li>
							...
							<ul class="copyright">
								<li>&copy; Online Railway Reservation System.</li><li>Developed By: Shivani Roshan Sahil</li>
							</ul>
						</div>
					</section>
