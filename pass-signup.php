      ...
      <div class="be-content">
        <div class="main-content container-fluid">
          <div class="splash-container">
              ...
              <!--Login Form-->
                <form method ="POST">
                  <div class="login-form">
                    ...
                    <div class="form-group">
                      <input class="form-control" name="pass_phone" pattern="[0-9]{10}" type="text" placeholder="Enter Your Phone Number" autocomplete="off">
                    </div>
                    <div class="form-group">
            ...
            <div class="splash-footer">&copy; 2019 - <?php echo date ('Y');?> Online Railway Reservation System | Developed By Shivani Roshan Sahil</div>
